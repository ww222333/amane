 ...
 */
export const testPlugin = <ThrowOnError extends boolean = false>(options: Options<TestPluginData, ThrowOnError>): RequestResult<TestPluginResponses, TestPluginErrors, ThrowOnError> => (options.client ?? client).post<TestPluginResponses, TestPluginErrors, ThrowOnError>({
