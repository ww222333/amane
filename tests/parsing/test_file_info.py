...
CASES: list[object] = [
    ...
    _Case("/media/38-068.mp4", number="38-068", content_type=ContentType.UNKNOWN),
    ...
    _Case("/media/Studio Name/video.mp4", number="VIDEO", content_type=ContentType.UNKNOWN),
    _Case("/media/downloads/video.mp4", number="VIDEO", content_type=ContentType.UNKNOWN),
    _Case("/media/Season02/video.mp4", number="VIDEO", content_type=ContentType.UNKNOWN),
    _Case("/media/2024-01/video.mp4", number="VIDEO", content_type=ContentType.UNKNOWN),
    _Case("/media/HDR10/video.mp4", number="VIDEO", content_type=ContentType.UNKNOWN),
    _Case("/media/DISC01/video.mp4", number="VIDEO", content_type=ContentType.UNKNOWN),
    _Case("/media/Vol.12/video.mp4", number="VIDEO", content_type=ContentType.UNKNOWN),
...
INFER_CONTENT_TYPE_CASES: list[tuple[str, str | None, ContentType]] = [
    ...
    ("38-068", None, ContentType.UNKNOWN),
    ...
    ("VIDEO", None, ContentType.UNKNOWN),
    ("Weekly Update", None, ContentType.UNKNOWN),
    ("just a movie title", None, ContentType.UNKNOWN),
